...
const modules = [
  { key: 'item-definitions', label: 'payroll.cn.item_definitions', desc: 'payroll.cn.item_definitions_desc', icon: '📋', color: '#6366f1' },
  { key: 'employees', label: 'payroll.cn.employees', desc: 'payroll.cn.employees_desc', icon: '👥', color: '#0f766e' },
  { key: 'batches', label: 'payroll.cn.batches', desc: 'payroll.cn.batches_desc', icon: '📅', color: '#e65100' },
  { key: 'payslips', label: 'payroll.cn.payslips', desc: 'payroll.cn.payslips_desc', icon: '📄', color: '#7c3aed' },
  { key: 'email-settings', label: 'payroll.cn.email_settings', desc: 'payroll.cn.email_settings_desc', icon: '📧', color: '#0891b2' },
]

function navigate(module: string) {
  router.push(`/payroll/cn/${module}`)
}
</script>
...
<template>
  <div class="launchpad">
    ...
    <header class="lp-hero">
      <div>
        <h1>{{ t('payroll.cn.title') }}</h1>
        <p>{{ t('payroll.cn.desc') }}</p>
      </div>
...
.lp-badge {
  flex-shrink: 0; background: #fef2f2; color: #b91c1c;
...
.lp-tile:hover {
  border-color: var(--tile-color, #b91c1c);
