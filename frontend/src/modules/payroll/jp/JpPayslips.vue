...
<template>
  <div class="fiori-page">
    ...
    <div class="fiori-filters">
      ...
      <el-button text type="info" @click="openLogDialog">📋 {{ t('payroll.payslip.send_log') }}</el-button>
    </div>
    ...
    <div class="batch-bar" :class="{ 'batch-disabled': !smtpConfigured }">
      <div class="batch-left">
        ...
        <span v-if="!smtpConfigured" style="font-size:.78rem;color:#e65100;">{{ t('payroll.payslip.smtp_notice_static', { url: '/payroll/jp/email-settings' }) }}</span>
      </div>
      <div class="batch-actions">
        <el-tooltip :content="!smtpConfigured ? '请先在{{ t('payroll.payslip.close') }}中配置SMTP' : ''" placement="top">
